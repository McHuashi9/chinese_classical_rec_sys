...
| 软件内截图 | 设置页进入截图模式，可截取任意界面并保存/分享/附带反馈 |
...
- `lib/pages/` read_hub · article_detail · my · settings · quiz · quiz_result · review_list · init_onboarding · init_result · welcome_page
- `lib/widgets/` reading_frame · original_text_view · radar_chart · annotation_popup · marked_sentence · stats_card · recent_reading_list · text_card · empty_state · dialogs · announcement_dialog · festival_dialog · feedback_dialog · init_quiz_guide_overlay · init_tutorial_overlay · profile_avatar · profile_dialogs · simple_markdown · screenshot_overlay
